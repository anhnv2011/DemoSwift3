...
SWIFT_CLASS("_TtC17FinalDetailMaster11AppDelegate")
...
SWIFT_CLASS("_TtC17FinalDetailMaster20DetailViewController")
...
SWIFT_CLASS("_TtC17FinalDetailMaster20MasterViewController")
@interface MasterViewController : UITableViewController <UISplitViewControllerDelegate>
@property (nonatomic) BOOL collapse;
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull cellArray;
- (void)viewDidLoad;
- (void)insertNewCell:(id _Nonnull)sender;
